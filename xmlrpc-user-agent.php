...
function xua_name_for_agent( $agent ) {
    $known_agents = array(
		...
		'/wp-android/' => 'WordPress for Android',
		'/wp-windowsphone/' => 'WordPress for Windows Phone 7',
		'/wp-nokia/' => 'WordPress for Nokia',
		'/wp-blackberry/' => 'WordPress for Blackberry',
    );
...
function xua_url_for_agent( $agent ) {
    $known_agents = array(
		...
		'/wp-android/' => 'http://android.wordpress.org/',
		'/wp-windowsphone/' => 'http://windowsphone.wordpress.org/',
		'/wp-nokia/' => 'http://nokia.wordpress.org/',
		'/wp-blackberry/' => 'http://blackberry.wordpress.org/',
    );
